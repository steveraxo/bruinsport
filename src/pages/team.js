              ...
              <div className={"row main__row"}>
                <div className={"col-md-12 col-xl-6"}>
                  ...
                  {pageAcf.first_column_copy.length > 0 ? (
                    <div
                      className={"team__extra__copy"}
                      dangerouslySetInnerHTML={{
                        __html: pageAcf.first_column_copy,
                      }}
                    />
                  ) : (
                    ""
                ...
                <div
                  className={
                    "col-md-12 col-xl-6 d-flex justify-element-end align-items-end team__extra__second__copy"
                  }
                >
                  {pageAcf.second_column_copy.length > 0 ? (
                    <div
                      dangerouslySetInnerHTML={{
                        __html: pageAcf.second_column_copy,
                      }}
                    />
                  ) : (
                    ""
                ...
                <div className="col-xl-12 hidden team__extra__content">
                  ...
                  <div className="col-xl-12 d-flex justify-content-center align-items-center">
                    <button className="" onClick={this.hideContent}>
                      Close
                    </button>
                  </div>
                </div>
              ...
              <div className={"container"}>
                ...
                <div className={"row team__members"}>
                  {pageAcf.team_members.map((member, index) => (
                    <div
                      className={
                        "col-xs-6 col-sm-6 col-md-6 col-xl-4 team-wrapper"
                      }
                      key={`${member.name}-${index}`}
                      tabIndex={0}
                      onKeyPress={this.triggerClientPopUp.bind(this)}
                                  ...
                                  <div className="featured__artitle__inner">
                                    ...
                                    {member.member_link ? (
                                      <div className="featured__article__cta">
                                        <ExternalButton
                                          redirectionLink={member.member_link}
